...
<body>
                ...
                <div class="col-lg-8 wow fadeInUp" data-wow-delay="0.1s">
                    <div class="owl-carousel testimonial-carousel">
                        ...
                        <div class="testimonial-item text-center">
                            ...
                            <p class="fs-4 text-white"><?php echo $rows['comment'];?></p>
    ...
    <!-- Footer Start -->
    <div class="container-fluid  text-light footer my-6 mb-0 py-6 wow fadeIn" data-wow-delay="0.1s" style="background-color:black">
        <div class="container">
            <div class="row g-5">
    ...
    <!-- Copyright Start -->
    <div class="container-fluid copyright text-light py-4 wow fadeIn" data-wow-delay="0.1s" style="background-color:black">
        <div class="container" >
            <div class="row">
                <div class="col-md-6 text-center text-md-start mb-3 mb-md-0">
                    &copy; <a href="#">Crusie</a>, All Right Reserved.
                </div>
