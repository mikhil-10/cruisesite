...
<body>
    ...
    <nav class="navbar navbar-expand-lg bg-white navbar-light sticky-top p-0">
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
            <div class="navbar-nav ms-auto p-4 p-lg-0">
                ...
                <a href="adminur.php" class="nav-item nav-link active">View Users</a>
                <a href="admincon.php" class="nav-item nav-link ">Contact</a>
    ...
    <div class="container-fluid page-header py-6 my-6 mt-0 wow fadeIn" data-wow-delay="0.1s">
        <div class="container text-center">
            <h1 class="display-4 text-white animated slideInDown mb-4">Admin View User</h1>
            <nav aria-label="breadcrumb animated slideInDown">
                <ol class="breadcrumb justify-content-center mb-0">
                    <li class="breadcrumb-item"><a class="text-white" href="adminlogin.html">Admin Login</a></li>

                    <li class="breadcrumb-item text-primary active" aria-current="page">Admin View User</li>
                </ol>
            </nav>
        </div>
    </div>
            ...
            <div class="row justify-content-center align-items-center g-2">
                ...
                if(mysqli_num_rows($result)>0){
                    ...
                    while ($rows=mysqli_fetch_assoc($result)) {
                        ...
                        <td>{$rows['contact']}</td>
                        <td>{$rows['username']}</td>
                        <td><a name='' id='' class='btn btn-danger' href='admindeleteur.php?id={$rows['id']}' role='button'>Delete</a></td>
