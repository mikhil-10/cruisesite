...
<body>
    ...
    <nav class="navbar navbar-expand-lg bg-white navbar-light sticky-top p-0">
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
            <div class="navbar-nav ms-auto p-4 p-lg-0">
                ...
                <a href="admincomment.php" class="nav-item nav-link active">Comments</a>
 ...
 <div class="container-fluid page-header py-6 my-6 mt-0 wow fadeIn" data-wow-delay="0.1s">
        <div class="container text-center">
            <h1 class="display-4 text-white animated slideInDown mb-4">Comments </h1>
            <nav aria-label="breadcrumb animated slideInDown">
                <ol class="breadcrumb justify-content-center mb-0">
                    <li class="breadcrumb-item"><a class="text-white" href="adminlogin.html">Admin login</a></li>
                    <li class="breadcrumb-item text-primary active" aria-current="page">Admin Register</li>
                </ol>
            </nav>
        </div>
    </div>
                    ...
                    <div class="col-lg-8 wow fadeInUp" data-wow-delay="0.1s">
                        ...
                        ?>
                            <div class="testimonial-item text-center">
                                ...
                                <h5>
                                    <?php echo $row['name']; 
                                    echo "<a name='' id='' class='btn btn-danger' href='deletecomment.php?id={$row["id"]}' role='button'>Delete</a>";?>
